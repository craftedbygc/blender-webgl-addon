...
def glbExpOp(folderpath,format,coll,ob,draco,material,skinned):
    ...
    export_textures.export(texFolder,ob)
...
def glbExp(draco,material):
    ...
    for ob in coll.objects:
        if ob is not None and ob.type == 'MESH': 
            obcount = checkAndExport(mainfolderpath,format,coll,ob,draco,material,obcount,skinned=False)
    ...
    for ob in coll.objects:   
        if ob is not None and ob.type == 'MESH':
            obcount = checkAndExport(mainfolderpath,format,coll,ob,draco,material,obcount,skinned=True)
